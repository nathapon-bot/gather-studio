...
>
    ...
    <div class="flex min-h-full flex-col-reverse mobile:flex-col">
        <section id="main-layout-main" class="pb-0 flex-1 pointer-events-none h-full w-full relative">
            <div class="fixed z-[1000] bottom-4 right-4 w-72 max-w-[90vw] mobile:bottom-20 mobile:right-2 mobile:w-[92vw]">
                <div class="popups flex flex-col-reverse gap-2">
                    {#each $popupStore.slice().reverse() as popup, index (popup.uuid)}
                        <div class="popupwrapper popupwrapper-{index}" in:fly={{ y: 40, duration: 300 }}>
                            <svelte:component
