...
export class GameScene extends DirtyScene {
    ...
    public cleanupClosingScene(): void {
        ...
        iframeListener.unregisterAnswerer("setPlayerSitting");
...
${escapedMessage}
        ...
        iframeListener.registerAnswerer("setPlayerSitting", (message) => {
            this.CurrentPlayer.setSitting(message.sitting);
        });
