...
export class WorkadventurePlayerCommands extends IframeApiContribution<WorkadventurePlayerCommands> {
    ...
    /**
     * Set the player's sitting state. When sitting, the character visually
     * shifts down and locks into a sit animation.
     *
     * @param {boolean} sitting Whether the player should sit or stand
     * @returns {Promise<void>}
     */
    public setSitting(sitting: boolean): Promise<void> {
        return queryWorkadventure({
            type: "setPlayerSitting",
            data: { sitting },
        });
    }
